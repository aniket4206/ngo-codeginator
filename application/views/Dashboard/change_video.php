                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">Video Table</h4>
                            ...
                            <div class="card-header">
                                <h5>
                                    <a role="button" class="btn btn-sm btn-secondary btn-round float-left" href="<?= base_url('video_p') ?>">
                                        <small class="">Back</small>
                                    </a>
                                    <a role="button" class="btn btn-sm btn-success btn-round float-right" href="<?= base_url('create_video') ?>">
                                        <small class="">New VIDEO</small>
                                    </a>
                                </h5>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td width="30%"> <img src="<?= "https://img.youtube.com/vi/". $row->video_link ."/mqdefault.jpg" ?>" style="width:250px">
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-warning btn-round m-2" href="<?php echo base_url() . 'Dashboard/delete_video/' . $row->id; ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php }
                                            } else { ?>
