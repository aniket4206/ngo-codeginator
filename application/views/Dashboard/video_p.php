          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title text-center">Video
                  <a role="button" class="btn btn-sm btn-success btn-round float-right" href="<?= base_url('change_video') ?>">
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <!-- <td>
                              <a class="btn btn-info btn-round m-2" href="<?php echo base_url() . 'Dashboard/edit_products/' . $row->id; ?>">Delete</a>
                            </td> -->
                          </tr>
                        <?php }
                      } else { ?>
