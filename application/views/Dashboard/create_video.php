                    ...
                    <div class="col-md-8 ml-auto mr-auto">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">Add Video
                                </h4>
                            </div>
                            <div class="card-body ">
                                <?= form_open_multipart('Add-Video'); ?>
                                <div class="row ml-auto mr-auto align-items-center justify-content-center">
                                    ...
                                    <div class="col-md-10 col-md-offset-2">
                                        <div class="form-group">
                                            <b><label class="col-md-3">Video Link :</label></b>
                                            <div class="col-md-9">
                                                <input type="text" name="video_link" value="<?php echo set_value('video_link'); ?>" class="form-control" id="video_link">
                                                <p style="color: red;"><?php echo form_error('video_link', "*"); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ml-auto mr-auto">
                                        ...
                                        <a type="submit" href="<?php echo base_url() . 'change_video' ?>" class="btn btn-secondary btn-round">Back</a>
                                    </div>
