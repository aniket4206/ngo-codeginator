            ...
            <div class="container">
                ...
                <div class="causes-wrap row">
                    <div class="col-md-4 xs-padding">
                        <div class="causes-content">
                           <div class="causes-thumb">
                                <img src="<?= base_url() ?>layout/img/causes-1.jpg" alt="causes">
                    ...
                    <div class="col-md-4 xs-padding">
                        <div class="causes-content">
                           <div class="causes-thumb">
                                <img src="<?= base_url() ?>layout/img/causes-2.jpg" alt="causes">
                                <a href="#" class="donate-btn">Donate Now<i class="ti-plus"></i></a>
                                <div class="progress">
                    ...
                    <div class="col-md-4 xs-padding">
                        <div class="causes-content">
                           <div class="causes-thumb">
                                <img src="<?= base_url() ?>layout/img/causes-3.jpg" alt="causes">
                                <a href="#" class="donate-btn">Donate Now<i class="ti-plus"></i></a>
                                <div class="progress">
                ...
                <div class="row">
                   <div class="col-md-4 xs-padding">
                        <div class="profile-wrap">
                            <img class="profile" src="<?= base_url() ?>layout/img/profile.jpg" alt="profile">
                            <h3>Jonathan Smith <span>CEO & Founder of Charitify.</span></h3>
                            <p>The secret to happiness lies in helping others. Never underestimate the difference YOU can make in the lives of the poor, the abused and the helpless.</p>
                            <img src="<?= base_url() ?>layout/img/sign.png" alt="sign">
                        </div>
                    </div>
                        ...
                        <div class="team-wrap row">
                            <div class="col-md-6">
                                <div class="team-details">
                                   <img src="<?= base_url() ?>layout/img/team-1.jpg" alt="team">
                                    <div class="hover">
                            ...
                            <!-- <div class="col-md-6">
                                <div class="team-details">
                                   <img src="<?= base_url() ?>layout/img/team-2.jpg" alt="team">
                                    <div class="hover">
                            ...
                            <!-- <div class="col-md-6">
                                <div class="team-details">
                                    <img src="<?= base_url() ?>layout/img/team-3.jpg" alt="team">
                                    <div class="hover">
                            ...
                            <!-- <div class="col-md-6">
                                <div class="team-details">
                                   <img src="<?= base_url() ?>layout/img/team-4.jpg" alt="team">
                                    <div class="hover">
      ...
      <!--  <section class="events-section bg-grey bd-bottom padding">
           <div class="container">
                ...
                <div id="event-carousel" class="events-wrap owl-Carousel">
                    ...
                    <div class="events-item">
                        <div class="event-thumb">
                           <img src="<?= base_url() ?>layout/img/events-2.jpg" alt="events">
                        </div>
                        <div class="event-details">
