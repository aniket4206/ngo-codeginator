        ...
        <!-- <div class="pager-header">
            <div class="container">
                <div class="page-content">
                    ...
                    <p>Help today because to    morrow you may be the one who <br>needs more helping!</p>
                    <ol class="breadcrumb">
        ...
        <div class="banner-area header-border-top-1 pt-80 pb-35">
            <div class="container">
                <div class="section-title-custome text-center mb-75" data-aos="fade-up" data-aos-delay="200">
                    <h2 style="font-size:3.5rem;color:#710712">❤️</h2>
                    <br><br>
                    <h2>Your Donation is Completed!</h2>
                    <p class="pt-3">Your Donation <u><?= $OrderId ?></u> has been completed. Your Donation details are <br>Sent in your Email.</p>
                </div>
            </div>
        </div>     
        <br /><br />   
