...
<!-- 
 ...
 <section class="contact-section padding">
            ...
            <div class="container ">
                           ...
                           <center> <h2>Log In</h2></center>
                            <!-- <form action="contact.php" method="post" id="ajax_form" class="form-horizontal">
                                <div class="form-group colum-row row">
                                    ...
                                    <div class="col-sm-8">
                                        <br /><input type="email" id="email" name="email" class="form-control" placeholder="Email" required>
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <button id="submit" class="default-btn" type="submit">Donate</button>
                                    </div>
                                </div>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                <button class="default-btn" type="submit" name="submit" value="Login">LOGIN</button>
                </div>
              </div>
              <?php echo form_close(); ?>
            </form>
